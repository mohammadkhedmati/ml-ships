...
# train yolov9 models
python train_dual.py --workers 8 --device 0 --batch 8 --data Object_detection/data.yaml --img 640 --cfg models/detect/yolov9-c.yaml --weights yolov9-c.pt --name yolov9-c-ships --hyp hyp.scratch-high.yaml --min-items 0 --epochs 100 --close-mosaic 15
