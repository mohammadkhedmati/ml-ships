...
model1 = YOLO("yolov9\\runs\\train\\yolov9-c-ships3\\weights\\best.pt")
...
if __name__ == '__main__': 
    ...
    # Benchmark on GPU
    # benchmark(model='runs\\detect\\ship_detection_yoloV8n\\weights\\best.pt', data='data.yaml',  half=False, device=0)
